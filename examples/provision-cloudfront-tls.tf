...
locals {
  ...
  # Note:  Cloudfront requires the ACM cert to be in us-east-1
  # If you use a different region, you'll need to manually create
  # the cert and reference it by ARN in the appropriate spot below
  region = "us-east-1" 
}
